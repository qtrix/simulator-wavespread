...
func addWavespreadFlags(cmd *cobra.Command) {
	...
	cmd.Flags().Bool("surfer-switch-side-anchor-enabled", false, "Enable surfer switch side exits")
	cmd.Flags().Bool("anchor-switch-side-surfer-enabled", false, "Enable anchor switch side exits")
}
